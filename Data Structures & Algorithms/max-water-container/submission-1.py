...
# We can optimize in two dimensions, width and height. We start at the biggest possible width, it won't get any better
# so just make sure you keep the height as high as possible, hence why we move the smaller 'tower'